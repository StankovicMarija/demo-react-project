    ...
    finance: [
      {
        ...
        text: 'Consolidate financial data from multiple sources and categorizetransactions up to 2 years of history. Analyze reports to reconcile activities in your account.',
        img: '/img/story/first.svg',
      },
      {
        ...
        img: '/img/story/second.svg',
      },
      {
        title: 'Consumer Payments',
        text: 'Its easier to set up secure bank payments with us through a flow designed with the user experience in mind. Customers could instantly authenticate their account.',
        img: '/img/story/third.svg',
      },
    ],
  },
  schedule: {
